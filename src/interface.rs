...
use webauthn_rs_core_icp::interface::{
    AttestationCaList, AuthenticationResult, AuthenticationState, RegistrationState,
};
use webauthn_rs_core_icp::proto::{COSEAlgorithm, Credential, CredentialID, ParsedAttestation};
...
pub struct PasskeyAuthentication {
    /// used to track the state of the authentication process
